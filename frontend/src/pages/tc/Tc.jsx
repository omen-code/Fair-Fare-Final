    ...
    <div>
      ...
      <div className="content">
        ...
        <p>
          ...
          Rapido. By accessing or using the FairFare app or website, you agree to
        ...
        <p>
          To use FairFare, you may be required to create an account. You agree to
        ...
        <p>
          When you use FairFare to book a ride, the actual transportation service
          is provided by a third-party provider (e.g., Ola, Uber, Rapido). You
          agree to comply with the terms and policies of these third-party
          providers. FairFare is not responsible for the actions, omissions, or
          policies of third-party providers, including but not limited to vehicle
          availability, ride quality, driver behavior, or pricing disputes.
        </p>

        <h2>4. Fares and Payments</h2>
        <p>
          Fare estimates provided on the FairFare platform are based on
          information supplied by third-party providers. Actual fares may vary due
          to factors such as traffic, demand, and route changes. Payments for
          rides are processed by the third-party providers, and FairFare does not
          collect or manage payments directly. You acknowledge that any disputes
          related to fares, refunds, or cancellations must be addressed with the
        ...
        <p>
          ...
          responsible for any fees or charges related to cancellations. It is your
          responsibility to review the cancellation and refund policies of the
          third-party provider before confirming a booking.
        </p>
        ...
        <ul>
          <li>
            Use the Service in a lawful manner and only for the purposes intended.
          </li>
          <li>
          ...
          <li>
            Not attempt to interfere with the operation of the Service, including
            hacking, reverse engineering, or introducing viruses.
          </li>
        </ul>
        ...
        <p>
          ...
          third-party providers. All ratings and reviews must be honest and based
          on actual experiences. You agree not to submit any false, misleading, or
          defamatory content. FairFare reserves the right to remove or edit
          reviews that violate these Terms or applicable laws.
        </p>
        ...
        <p>
          ...
          provides a platform to facilitate ride comparison and bookings, but the
          transportation service is solely provided by third-party providers, over
          which FairFare has no control.
        </p>
        ...
        <p>
          ...
          activities, or misuse the Service. Upon termination, you will no longer
          be permitted to use the Service, and your account may be deactivated.
        </p>

        <h2>11. Governing Law and Dispute Resolution</h2>
        <p>
          These Terms are governed by and construed in accordance with the laws of
          [Insert Jurisdiction]. Any disputes arising out of or relating to these
          Terms or the use of FairFare will be subject to the exclusive
          jurisdiction of the courts located in [Insert Jurisdiction].
        </p>

        <h2>12. Amendments</h2>
        <p>
          FairFare reserves the right to modify or update these Terms at any time.
